    ...
    <footer class="footer">
        <div class="footer__bg">
            <div class="footer__container container grid">
                <div>
                    <h1 class="footer__title">SocRob@Home</h1>
                    <span class="footer__subtitle">
                        <v-icon class="footer-icon-bulb mr-1">mdi-robot-outline</v-icon>
                        Institute for Systems & Robotics
                    </span>
                    <!-- <p class="footer__mail">socrob.home@gmail.com</p> -->
                    <p class="footer__mail">
                        <v-icon class="footer-icon-bulb mr-1">mdi-email-outline</v-icon>
                        socrob.home@gmail.com
                        <!-- <i class="uil uil-robot footer-icon-bulb"></i> -->
                    </p>
                    <span class="footer__subtitle">
                        <div style="display: flex;">
                            <v-icon class="footer-icon-bulb mr-1">mdi-map-marker</v-icon>
                            Av. Rovisco Pais, 1, 1049-001 Lisboa <br> (ISR, Torre Norte, 8º Piso)
                        </div>
                        <!-- <i class="uil uil-robot footer-icon-bulb"></i> -->
                    </span>
                </div>
                ...
                <div class="footer__socials">
                    ...
                    <a href="https://github.com/socrob" target="_blank" rel="noreferrer" class="footer__social">
                        <v-icon>mdi-github</v-icon>
                    </a>
                </div>
                <div class="footer__robot">
                    <svg class="footer__icon" viewBox="0 0 171 171" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="footer__sponsors">
                ...
                <a href="https://www.facebook.com/Tdreams7/?locale=pt_PT" target="_blank">
                    <img src="/logos/white_logo.png" alt="TDreams" class="footer__sponsor-logo footer__sponsor-logo-tdreams" />
                </a>
            </div>
...
<style scoped lang="scss" src="@/assets/footer.scss"></style>